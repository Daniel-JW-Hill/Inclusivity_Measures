...
get_decomposition_indiv = function(indiv_data, 
  ...
  fitted_opportunity =  predict(model_indiv_direct, newdata = indiv_data_pbar, type = 'response' )
  fitted_preferences = predict(model_indiv_direct, newdata = indiv_data_cbar, type = 'response' )
  fitted_outcomes = predict(model_indiv_direct, data = indiv_data, type = 'response')
  ...
  for (i in 1:length(C_indiv)) {
    ...
    pred_opportunity_c = predict(model_indiv_direct, newdata = indiv_data_new, type = 'response')
  ...
  write.csv(opportunity_decomp_indiv, file = here("Results", "Opportunity decomposition binary indiv direct model.csv"))
